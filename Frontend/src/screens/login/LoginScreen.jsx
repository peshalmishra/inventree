  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#0a0a0f] relative overflow-hidden">
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full opacity-20 blur-3xl bg-gradient-to-br from-violet-500 to-transparent" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full opacity-10 blur-3xl bg-gradient-to-br from-sky-500 to-transparent" />
      </div>

      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 glass-panel overflow-hidden relative z-10">
        <motion.div
        ...
        >
          ...
          {error && (
            <motion.div
              ...
              className="mb-4 px-4 py-3 rounded-2xl text-sm text-red-400 bg-red-400/10 border border-red-400/20"
            >
              {error}
            </motion.div>
          )}
          ...
          <form onSubmit={handleSignIn} className="space-y-5">
            <div>
              <label htmlFor="email" className="block text-xs font-semibold text-white/40 mb-1.5">
                Email
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="input-recessed pl-9"
                />
              </div>
            </div>

            <div>
              <label htmlFor="password" className="block text-xs font-semibold text-white/40 mb-1.5">
                Password
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  onChange={handleInputChange}
                  className="input-recessed pl-9 pr-9"
                />
                <button
                  type="button"
            ...
            <button type="submit" disabled={loading} className="glow-button w-full flex items-center justify-center gap-2 disabled:opacity-60">
              {loading ? (
