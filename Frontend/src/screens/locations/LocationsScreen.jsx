...
import { Plus, MapPin, User, Mail, Pencil } from "lucide-react";
    ...
    <div className="p-6 space-y-5 max-w-[1400px]">
      <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-white/40 mt-1">Manage storage and office locations</p>
        </div>
        <Link to="new" className="btn-primary flex items-center gap-2">
          <Plus size={16} /><span>New Location</span>
        </Link>
      </motion.div>
    ...
    <div className="glass-card-hover p-5 flex flex-col gap-3 h-full relative group">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <span className="badge-purple text-[10px]">Location</span>
        </div>
      </div>
